...
<div class="container">
    ...
    <div class="row featurette">
        <div class="col-md-5 order-md-2  bg-light ">
            <!-- <h1>logon</h1> -->
            ...
            <div class="container col-8">
                ...
                <form action="<?php base_url('/');?>" method="post">
                    <h1 class="p-4 text-dark">User Login</h1>
        ...
        <div class="col-md-7 order-md-1">
            ...
            <img src="<?php echo base_url('public/pic/picture60.jpg');?>" height="400px" width="646px" alt="">
        </div>
    </div>
    <hr class="featurette-divider">
        ...
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb"
                    ...
                    src="<?php echo base_url('public/pic/picture21.jpg');?>" data-holder-rendered="true">
            </div>
        </div>
        <div class="col-md-6">
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                ...
                <img class="card-img-right flex-auto d-none d-md-block" data-src="holder.js/200x250?theme=thumb"
                    alt="Thumbnail [200x250]" src="<?php echo base_url('public/pic/picture20.jpg');?>"
