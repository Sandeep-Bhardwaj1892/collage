    ...
    <span class="navbar-toggler-icon"></span>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="text-primary">
                <a class="btn btn-outline-primary btn-sm  my-2 my-sm-0 mr-sm-3"
                    href="<?php echo base_url('/logout');?>">Logout </a>
                <a class="btn btn-sm btn-outline-primary  my-2 my-sm-0 mr-sm-2"
                    href="<?php echo base_url('signup');?>">Signup</a>
            </div>
        </div>
    </nav>
